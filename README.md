...
Note that Swift 3 conversation done by automatic migrator assistant, therefore namings and conventions might not be completely fitting to official guidelines.
